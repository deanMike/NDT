...
toolbox_directory_name = 'C:Usersmkd20Downloadsndt.1.0.4_exported'  % put name of path to the Neural Decoding Toolbox
...
binned_data_file_name = 'C:Usersmkd20DownloadsZhang_Desimone_7objects_raster_data/binned';

if isempty(binned_data_file_name)
raster_data_directory_name = 'C:Usersmkd20DownloadsZhang_Desimone_7objects_raster_data';   % put name of path to the raster data
