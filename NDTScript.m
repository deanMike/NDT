...
toolbox_directory_name = 'toolbox'  % put name of path to the Neural Decoding Toolbox
...
binned_data_file_name = 'toolbox/Binned_Zhang_Desimone_7object_data_150ms_bins_50ms_sampled.mat';

if isempty(binned_data_file_name)
 raster_data_directory_name = 'C:Usersmkd20DocumentsGitHubNDToutput';   % put name of path to the raster data
