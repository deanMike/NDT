...
raster_data_directory_name = 'dataPath/';   % put name of path to the raster data
...
load([raster_data_directory_name 'neuronName']) 
...
% save the results
save_file_name = 'savePrefix_Results';
